    ...
    public partial class AccessControlClient : IAccessControlClient
    {
        ...
        public virtual async System.Threading.Tasks.Task UpdateConfigurationAsync(RoleDto updatedRole, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    var content_ = new System.Net.Http.StringContent(Newtonsoft.Json.JsonConvert.SerializeObject(updatedRole, _settings.Value));
    ...
    public partial class RolesClient : IRolesClient
    {
        ...
        public virtual async System.Threading.Tasks.Task<RoleDto> PostRoleAsync(RoleDto newRole, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    var content_ = new System.Net.Http.StringContent(Newtonsoft.Json.JsonConvert.SerializeObject(newRole, _settings.Value));
                    content_.Headers.ContentType = System.Net.Http.Headers.MediaTypeHeaderValue.Parse("application/json");
                    request_.Content = content_;
